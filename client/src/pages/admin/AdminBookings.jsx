    ...
    try {
      ...
      if (res.data.success || res.data.bookings) {
        ...
        const processed = rawBookings.map((b) => {
          const isPastOrCompleted = b.status === "Completed" || (b.date && b.date <= todayStr);
          if (isPastOrCompleted && b.status !== "Rejected" && b.status !== "Cancelled") {
            return {
              ...b,
      ...
      <div className="space-y-8">
        ...
        <div className="grid grid-cols-2 xl:grid-cols-5 gap-5">
          <div className="bg-white rounded-3xl shadow p-6">
            <BookOpen className="text-orange-600 mb-3" size={28} />
          ...
          <div className="bg-blue-50 rounded-3xl shadow p-6">
            ...
            <p className="text-blue-700">Accepted</p>
            <h2 className="text-3xl font-black mt-2">{acceptedBookings}</h2>
          </div>

          <div className="bg-green-50 rounded-3xl shadow p-6">
            <CheckCircle className="text-green-600 mb-3" size={28} />
            <p className="text-green-700">Completed</p>
            <h2 className="text-3xl font-black mt-2">{completedBookings}</h2>
          </div>

          <div className="bg-orange-50 rounded-3xl shadow p-6">
            <IndianRupee className="text-orange-600 mb-3" size={28} />
            <p className="text-orange-700">Total Revenue</p>
