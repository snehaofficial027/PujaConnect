...
const AdminContact = () => {
  ...
  const todayMessages = safeMessages.filter((msg) => {
  ...
  const monthMessages = safeMessages.filter((msg) => {
    if (!msg.createdAt) return false;
      ...
      <div className="space-y-8">
        ...
        <div className="grid grid-cols-2 xl:grid-cols-4 gap-5">
          <div className="bg-blue-50 rounded-3xl p-6 shadow">
            <p className="text-blue-600 font-medium">Total Messages</p>
            <h2 className="text-3xl font-black mt-2">{totalMessages}</h2>
          </div>

          <div className="bg-green-50 rounded-3xl p-6 shadow">
            <p className="text-green-600 font-medium">Today's Messages</p>
            <h2 className="text-3xl font-black mt-2">{todayMessages}</h2>
          </div>

          <div className="bg-orange-50 rounded-3xl p-6 shadow">
            <p className="text-orange-600 font-medium">This Month</p>
            <h2 className="text-3xl font-black mt-2">{monthMessages}</h2>
          </div>

          <div className="bg-purple-50 rounded-3xl p-6 shadow">
            <p className="text-purple-600 font-medium">Total Contacts</p>
            <h2 className="text-3xl font-black mt-2">{totalMessages}</h2>
          </div>
        </div>
