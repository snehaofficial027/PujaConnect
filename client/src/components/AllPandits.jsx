...
const AllPandits = ({ onBookClick }) => {
  ...
  // Dummy Data (Only if API fails or returns empty)
  const defaultPandits = [
    {
      ...
      city: "Ahmedabad",
      online: true,
      image: "https://images.unsplash.com/photo-1566616213894-2d4e1baee5d8?w=500",
    },
    {
      _id: "2",
    ...
    },
    {
      ...
      city: "Surat",
      online: true,
      image: "https://images.unsplash.com/photo-1624561172888-ac93c696e10c?w=500",
    },
    {
      _id: "4",
      name: "Rajesh Sharma",
  ...
  const getImageUrl = (imgPath) => {
    if (!imgPath) return "https://images.unsplash.com/photo-1566616213894-2d4e1baee5d8?w=500";
    if (imgPath.startsWith("http")) return imgPath;
    
    // API નો baseURL લઈ ઈમેજનો લાઈવ પાથ બનાવશે
        ...
        <div className="w-full flex flex-wrap justify-center gap-6">
          {filteredPandits.length > 0 ? (
            filteredPandits.map((pandit) => {
              const fullImgUrl = getImageUrl(pandit.image || pandit.profileImage);
                ...
                >
                  ...
                  <div className="relative h-64 overflow-hidden bg-gray-100">
                    <img
                      ...
                      onError={(e) => {
                        e.target.src = "https://images.unsplash.com/photo-1566616213894-2d4e1baee5d8?w=500";
                      }}
                    />
                    ...
                    >
                      {pandit.online !== false ? "🟢 Available" : "🔴 Unavailable"}
                    </span>
                  </div>
                  ...
                  <div className="p-5 flex flex-col flex-1">
                    ...
                    <div className="flex justify-between items-center mt-2">
                      <span className="bg-orange-50 text-orange-600 text-[11px] px-2 py-1 rounded-full">
                        {pandit.experience || 10} Years Exp
                      </span>
